...
class User extends DataClass implements Insertable<User> {
  ...
  User({required this.id, required this.name, this.preferences});
  ...
  factory User.fromJson(Map<String, dynamic> json,
    ...
    return User(
      ...
      preferences: serializer.fromJson<List<Preferences>?>(json['preferences']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'preferences': serializer.toJson<List<Preferences>?>(preferences),
    };
  }

  User copyWith({int? id, String? name, List<Preferences>? preferences}) =>
      User(
        id: id ?? this.id,
        name: name ?? this.name,
...
class UsersCompanion extends UpdateCompanion<User> {
  ...
  final Value<List<Preferences>?> preferences;
  ...
  static Insertable<User> custom({
    ...
    Expression<List<Preferences>?>? preferences,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
  ...
  UsersCompanion copyWith(
      {Value<int>? id,
      Value<String>? name,
      Value<List<Preferences>?>? preferences}) {
    return UsersCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
      preferences: preferences ?? this.preferences,
...
class $UsersTable extends Users with TableInfo<$UsersTable, User> {
  ...
  @override
  late final GeneratedColumnWithTypeConverter<List<Preferences>, String?>
      preferences = GeneratedColumn<String?>('preferences', aliasedName, true,
              type: const StringType(), requiredDuringInsert: false)
          .withConverter<List<Preferences>>($UsersTable.$converter0);
  @override
  List<GeneratedColumn> get $columns => [id, name, preferences];
  @override
  ...
  static TypeConverter<List<Preferences>, String> $converter0 =
